...
### Steps
- Compare values from the back of both arrays.
- Place the larger value at index `k`.
- Move the appropriate pointer left.
- Continue until all elements from `customerData2` are merged.

This guarantees correctness while maintaining constant extra space.
